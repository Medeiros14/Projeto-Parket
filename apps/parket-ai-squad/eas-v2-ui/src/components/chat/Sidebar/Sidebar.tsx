...
const PanelsNav = () => (
  <div className="grid w-full grid-cols-3 gap-1">
    {[
      ...
      ['/painel/memorias', 'Memórias'],
      ['/painel/knowledge', 'Knowledge'],
      ['/painel/schedules', 'Schedules'],
      ['/painel/workflows', 'Workflows'],
      ['/painel/evals', 'Evals'],
      ['/painel/learnings', 'Learnings'],
      ['/painel/toolkits', 'Toolkits']
    ].map(([href, label]) => (
      <Link
        key={href}
        href={href}
        className="flex h-8 items-center justify-center rounded-xl border border-primary/15 bg-accent text-[10px] font-medium uppercase text-muted transition hover:text-primary"
      >
        {label}
      </Link>
    ))}
