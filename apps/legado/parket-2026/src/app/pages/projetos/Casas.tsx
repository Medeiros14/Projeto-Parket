...
const images = [
  "https://parket.com.br/wp-content/uploads/2025/10/INS_CA-01.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_CA-02.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_CA-03.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_CA-04.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_CA-05.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_CA-06.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_CA-07.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_CA-08.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_CA-09.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_CA-10.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_CA-11.jpg",
];
...
export function Casas() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Casas — Projetos Parket"
        description="Inspire-se em projetos de casas sofisticadas com pisos e revestimentos em madeira nobre da Parket."
        keywords="casas, projetos residenciais, pisos de madeira, revestimentos, inspiração"
      />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Residências que celebram a arquitetura contemporânea através da madeira nobre. Projetos que integram natureza e design em perfeita harmonia.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
            <div className="max-w-[800px]">
              ...
              <p
                ...
                style={regular}
              >
                Uma seleção de projetos residenciais que utilizam madeira como elemento central de design, criando ambientes que integram natureza e sofisticação.
              </p>
            </div>
            ...
            >
              {images.map((img, i) => (
                ...
                >
                  <img
                    src={img}
                    alt={`Casas ${String(i + 1).padStart(2, "0")}`}
