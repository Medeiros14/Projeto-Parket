...
const images = [
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-01.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-02.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-03.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-04.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-05.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-06.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-07.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-08.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-09.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-10.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-11.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-12.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-13.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_RE-14.jpg",
];
...
export function Restaurantes() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Restaurantes — Projetos Parket"
        description="Inspire-se em projetos de restaurantes e espaços gastronômicos com pisos e revestimentos em madeira nobre da Parket."
        keywords="restaurantes, projetos gastronômicos, pisos de madeira, revestimentos, inspiração"
      />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Espaços gastronômicos que proporcionam experiências sensoriais únicas através da madeira nobre. Ambientes que harmonizam sabor, design e materialidade.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
            <div className="max-w-[800px]">
              <h2
                ...
                style={thin}
              >
                Projetos em Restaurantes
              </h2>
              <p
                className="text-[#E8E4DF]/50 text-[15px] md:text-[16px] leading-[1.7]"
                style={regular}
              >
                Restaurantes e espaços gastronômicos que utilizam madeira nobre para criar ambientes acolhedores e memoráveis.
              </p>
            </div>
            ...
            >
              {images.map((img, i) => (
                ...
                >
                  <img
                    src={img}
                    alt={`Restaurantes ${String(i + 1).padStart(2, "0")}`}
