...
import heroImage from "figma:asset/72b9f3a2937ddface3b5830375ed5d6b839e715c.jpg";
import { ZoomImage } from "../../components/ZoomImage";

const images = [
  heroImage,
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-01.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-02.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-03.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-04.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-05.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-06.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-07.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-08.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-09.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-10.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-11.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-12.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-13.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-14.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-15.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-16.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-17.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-18.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_LO-19.jpg",
];
...
export function Lojas() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Lojas — Projetos Parket"
        description="Inspire-se em projetos de lojas e espaços comerciais com pisos e revestimentos em madeira nobre da Parket."
        keywords="lojas, projetos comerciais, pisos de madeira, revestimentos, inspiração"
      />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Espaços comerciais que transformam a experiência de compra através da madeira nobre. Ambientes que unem identidade de marca e sofisticação material.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
            <div className="max-w-[800px]">
              ...
              <p
                ...
                style={regular}
              >
                Espaços comerciais que utilizam madeira nobre como elemento central de identidade visual, criando experiências memoráveis para os clientes.
              </p>
            </div>
            ...
            >
              {images.map((img, i) => (
                ...
                >
                  <img
                    src={img}
                    alt={`Lojas ${String(i + 1).padStart(2, "0")}`}
