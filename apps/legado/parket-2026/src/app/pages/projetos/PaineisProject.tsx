...
/*  Page Component                                      */
/* ═════════════════════════════════════════════════════ */
export function PaineisProject() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Painéis — Projetos Parket"
        description="Inspire-se em projetos com painéis decorativos, acústicos e 3D em madeira nobre da Parket."
        keywords="painéis de madeira, painéis decorativos, painéis acústicos, painéis 3D, projetos"
      />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Paredes que se transformam em elementos escultóricos. Painéis decorativos, acústicos e 3D que conferem profundidade visual e identidade contemporânea aos espaços.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
            <div className="max-w-[800px]">
              <h2
                ...
                style={thin}
              >
                Projetos com Painéis
              </h2>
              <p
                className="text-[#E8E4DF]/50 text-[15px] md:text-[16px] leading-[1.7]"
                style={regular}
              >
                Projetos que utilizam painéis de madeira como elemento decorativo central, criando paredes, divisórias e revestimentos de impacto visual.
              </p>
            </div>
            ...
            >
              {images.map((img, i) => (
                ...
                >
                  <img
                    src={img}
                    alt={`Painéis ${String(i + 1).padStart(2, "0")}`}
