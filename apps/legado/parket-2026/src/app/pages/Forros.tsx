...
const collections = [
  {
    ...
    name: "Forro Contínuo",
    description:
      "O forro contínuo Parket cria superfícies uniformes e fluidas, onde as junções entre as tábuas são praticamente imperceptíveis. Ideal para ambientes que pedem amplitude visual e acabamento impecável. Disponível em diversas espécies e larguras, com encaixe macho e fêmea que garante alinhamento perfeito.",
    images: Array.from({ length: 8 }, (_, i) =>
      `https://parket.com.br/wp-content/uploads/2025/10/PRO_FO-${String(i + 1).padStart(2, "0")}.jpg`
    ),
  },
  {
    id: "ripado",
    name: "Forro Ripado",
    description:
      "O forro ripado Parket introduz ritmo visual ao ambiente através de ripas espaçadas com precisão milimétrica. O espaçamento entre as ripas pode ser customizado, permitindo maior ou menor transparência e jogos de luz. Solução versátil para áreas internas e cobertas.",
    images: Array.from({ length: 8 }, (_, i) =>
      `https://parket.com.br/wp-content/uploads/2025/10/PRO_FO-${String(i + 9).padStart(2, "0")}.jpg`
    ),
  },
  {
    id: "colmeia",
    name: "Forro Colmeia",
    description:
      "O forro colmeia Parket combina função acústica com design expressivo. As réguas posicionadas verticalmente criam uma trama que absorve e difunde o som, ao mesmo tempo em que confere identidade visual marcante ao ambiente. Indicado para espaços corporativos, restaurantes e residências.",
    images: Array.from({ length: 9 }, (_, i) =>
      `https://parket.com.br/wp-content/uploads/2025/10/PRO_FO-${String(i + 17).padStart(2, "0")}.jpg`
    ),
  },
];
...
export function Forros() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Forros de Madeira — Contínuo, Ripado e Colmeia"
        description="Forros em madeira natural: contínuo, ripado e colmeia. 25 projetos reais. Cumaru, Ipê, Tauari, Freijó e Carvalho Europeu. Solicite orçamento."
        url="https://parket.com.br/forros"
      ...
      <section className="relative h-[60vh] md:h-[75vh] w-full overflow-hidden">
        <img
          src="https://parket.com.br/wp-content/uploads/2025/10/PRO_FO-01.jpg"
          alt="Forros de madeira Parket"
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Forros em madeira natural que transformam tetos em superfícies de grande expressão
              arquitetônica. 3 tipologias, 25 projetos reais.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-10 lg:px-20">
          ...
          >
            ...
            <h2
              ...
              style={thin}
            >
              O teto que abraça cada ambiente
            </h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
              <div className="space-y-5">
                <p className="text-[#E8E4DF]/80 text-[16px] leading-[1.75]" style={regular}>
                  O forro em madeira é uma das soluções mais versáteis da arquitetura contemporânea.
                  Além da{" "}
                  <strong className="text-[#E8E4DF]" style={medium}>
                    beleza natural incomparável
                  </strong>
                  , a madeira oferece conforto térmico e acústico, reduzindo a reverberação sonora e
                  contribuindo para ambientes mais silenciosos e agradáveis.
                </p>
                <p className="text-[#E8E4DF]/60 text-[16px] leading-[1.75]" style={regular}>
                  Na Parket, cada forro é produzido com madeira de procedência certificada, secagem
                  controlada e beneficiamento de precisão. Oferecemos três tipologias principais —
                  contínuo, ripado e colmeia — que podem ser customizadas em espécie, dimensão e
                  acabamento para atender à linguagem exata do seu projeto arquitetônico.
                </p>
                <div className="pt-4 space-y-3 border-t border-[#E8E4DF]/10">
                  <p className="text-[#E8E4DF]/70 text-[15px] leading-[1.7]" style={regular}>
                    ...
                    Cumaru, Ipê, Tauari, Freijó, Carvalho Europeu, Cedro Rosa
                  </p>
                  <p className="text-[#E8E4DF]/70 text-[15px] leading-[1.7]" style={regular}>
                    <strong className="text-[#E8E4DF]" style={medium}>
                      Acabamentos:
                    </strong>{" "}
                    Natural Acetinado, Stain Impregnante, Óleo Natural, Verniz UV, Defumado
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-10 lg:px-20 text-center">
          ...
          >
            ...
            >
              ...
              diretamente com um especialista em forros.
            </p>
            <a
