...
import japanHouse from "../../../assets/japan-house-sf.jpg";

const images = [
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-01.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-02.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-03.jpg",
  japanHouse,
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-05.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-06.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-07.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-08.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-09.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-10.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-11.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-12.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-13.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-14.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-15.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-16.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MU-17.jpg",
];
...
export function Museus() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Museus — Projetos Parket"
        description="Inspire-se em projetos de museus e espaços culturais com pisos e revestimentos em madeira nobre da Parket."
        keywords="museus, projetos culturais, pisos de madeira, revestimentos, inspiração"
      />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Espaços culturais que preservam memórias através da materialidade da madeira nobre. Projetos que unem história, arte e arquitetura atemporal.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
            <div className="max-w-[800px]">
              ...
              <p
                ...
                style={regular}
              >
                Espaços culturais e museológicos que incorporam madeira nobre para criar ambientes de contemplação e interação com arte e cultura.
              </p>
            </div>
            ...
            >
              {images.map((img, i) => (
                ...
                >
                  <img
                    src={img}
                    alt={`Museus ${String(i + 1).padStart(2, "0")}`}
