...
const heroImage = "https://parket.com.br/wp-content/uploads/2025/10/PRO_PA-01.jpg";
...
export function Paineis() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Painéis em Madeira — Parket"
        description="Revestimentos verticais e painéis em madeira nobre que transformam superfícies em elementos de destaque."
      />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Revestimentos verticais que transformam superfícies em elementos de destaque. Painéis ripados, contínuos e peças sob medida em madeira nobre.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-10 lg:px-20 text-center">
          ...
          >
            ...
            >
              ...
              diretamente com um especialista em painéis.
            </p>
            <a
