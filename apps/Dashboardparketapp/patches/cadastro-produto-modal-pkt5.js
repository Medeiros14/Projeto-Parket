...
const CATEGORY_CONFIG = {
  ...
  marcenaria: {
    label: "Marcenaria", unit: "m²",
    fields: [
      { key: "tipo_acabamento", label: "Tipo de Acabamento", options: ["Lâmina", "Lâmina Colorida", "Laca"] },
      { key: "acabamento_externo", label: "Acabamento Externo", options: ["Lâmina Natural", "Lâmina Imbuia", "Lâmina Carvalho Europeu", "Lâmina Nogueira", "Lâmina Sucupira", "Lâmina Cabreúva", "Lâmina Tauari", "Lâmina Cumaru", "Lâmina Loro Pardo", "Laca Branco TX", "Laca Branco Diamante Essencial", "Laca Mont Blanc", "Laca Marrone", "Laca Naturalle", "Laca Cappuccino", "Laca Baby Grey", "Laca Grigio Nero", "Laca Light Brown", "Laca Milano", "Laca Smoked"] },
      { key: "acabamento_interno", label: "Acabamento Interno", options: ["Lâmina Natural", "Lâmina Imbuia", "Lâmina Carvalho Europeu", "Lâmina Nogueira", "Lâmina Sucupira", "Lâmina Cabreúva", "Lâmina Tauari", "Lâmina Cumaru", "Lâmina Loro Pardo", "Laca Branco TX", "Laca Branco Diamante Essencial", "Laca Mont Blanc", "Laca Marrone", "Laca Naturalle", "Laca Cappuccino", "Laca Baby Grey", "Laca Grigio Nero", "Laca Light Brown", "Laca Milano", "Laca Smoked"] },
      { key: "cor", label: "Cor (opcional)", options: ["Branco TX", "Branco Diamante Essencial", "Mont Blanc", "Marrone", "Naturalle", "Cappuccino", "Baby Grey", "Grigio Nero", "Light Brown", "Milano", "Smoked", "Customizado"] },
      { key: "aplicacao", label: "Aplicação", options: ["Estante", "Armário", "Closet", "Cozinha", "Banheiro", "Cabine", "Painel TV", "Boiserie", "Home Office", "Lavanderia"] },
    ],
  },
};
...
<div>
  ...
  $("__pkt_save").onclick = async () => {
    ...
    const payload = {
      ...
      subtipo: (()=>{const __raw=atributos_extras.subtipo?atributos_extras.subtipo.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/\s+/g,"_"):"regua";return (cat==="painel"||cat==="revestimento")&&__raw==="regua"?"reguas":__raw;})(),
