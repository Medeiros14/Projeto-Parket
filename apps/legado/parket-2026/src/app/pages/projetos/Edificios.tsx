...
const images = [
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ED-01.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ED-02.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ED-03.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ED-04.jpg",
];
...
export function Edificios() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Edifícios — Projetos Parket"
        description="Inspire-se em projetos de edifícios comerciais e corporativos com pisos e revestimentos em madeira nobre da Parket."
        keywords="edifícios, projetos comerciais, pisos de madeira, revestimentos, inspiração"
      />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Projetos comerciais e corporativos que elevam o padrão arquitetônico através da madeira nobre. Espaços que combinam elegância e funcionalidade.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
            <div className="max-w-[800px]">
              <h2
                ...
                style={thin}
              >
                Projetos em Edifícios
              </h2>
              <p
                className="text-[#E8E4DF]/50 text-[15px] md:text-[16px] leading-[1.7]"
                style={regular}
              >
                Edifícios que incorporam madeira nobre em suas áreas comuns e fachadas, elevando o padrão de sofisticação e exclusividade.
              </p>
            </div>
            ...
            >
              {images.map((img, i) => (
                ...
                >
                  <img
                    src={img}
                    alt={`Edifícios ${String(i + 1).padStart(2, "0")}`}
