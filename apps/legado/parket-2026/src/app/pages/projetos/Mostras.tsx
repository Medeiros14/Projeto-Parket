...
import heroImage from "figma:asset/48bd54a5e044cb8bba4557d082ebb0ae0a6c222d.jpg";
import { ZoomImage } from "../../components/ZoomImage";

const images = [
  heroImage,
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-01.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-02.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-03.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-04.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-05.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-06.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-07.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-08.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-09.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-10.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-11.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-12.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-13.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-14.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-15.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-16.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-17.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-18.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_MO-19.jpg",
];
...
export function Mostras() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Mostras — Projetos Parket"
        description="Inspire-se em projetos de mostras e exposições com pisos e revestimentos em madeira nobre da Parket."
        keywords="mostras, exposições, projetos, pisos de madeira, revestimentos, inspiração"
      />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Exposições e mostras temporárias que celebram a madeira nobre como protagonista. Projetos que transformam espaços efêmeros em experiências inesquecíveis.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
            <div className="max-w-[800px]">
              ...
              <p
                ...
                style={regular}
              >
                Participações em mostras e exposições de design e arquitetura, onde a madeira nobre é protagonista de ambientes conceituais e inspiradores.
              </p>
            </div>
            ...
            >
              {images.map((img, i) => (
                ...
                >
                  <img
                    src={img}
                    alt={`Mostras ${String(i + 1).padStart(2, "0")}`}
