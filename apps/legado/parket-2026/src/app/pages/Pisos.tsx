...
import classico1 from "../../assets/PRO_PI_CL_EXT_01.jpg";
import classico2 from "../../assets/PRO_PI_CL_EXT_02.jpg";
import classico3 from "../../assets/PRO_PI_CL_EXT_03.jpg";
import classico4 from "../../assets/PRO_PI_CL_EXT_04.jpg";
import classico5 from "../../assets/PRO_PI_CL_EXT_05.jpg";
import eterno1 from "../../assets/PRO_PI_ET_EXT_01.jpg";
import eterno2 from "../../assets/PRO_PI_ET_EXT_02.jpg";
import eterno3 from "../../assets/PRO_PI_ET_EXT_03.jpg";
import eterno4 from "../../assets/PRO_PI_ET_EXT_04.jpg";
import eterno5 from "../../assets/PRO_PI_ET_EXT_05.jpg";
import brazil_ext1 from "../../assets/PRO_PI_BR_EXT_01.jpg";
import classico6 from "../../assets/PRO_PI_CL_EXT_06.jpg";
import classico7 from "../../assets/PRO_PI_CL_EXT_07.jpg";
import classico8 from "../../assets/PRO_PI_CL_EXT_08.jpg";
import classico9 from "../../assets/PRO_PI_CL_EXT_09.jpg";
import classico10 from "../../assets/PRO_PI_CL_EXT_10.jpg";
import classico11 from "../../assets/PRO_PI_CL_EXT_11.jpg";
import classico12 from "../../assets/PRO_PI_CL_EXT_12.jpg";
import classico13 from "../../assets/PRO_PI_CL_EXT_13.jpg";
import classico14 from "../../assets/PRO_PI_CL_EXT_14.jpg";
import pisoHero from "../../assets/PRO_PI_HERO.jpg";
import { handleLeadFormClick } from "../lib/leadForm";

/* ─── Collections Data (same as parket.com.br) ─── */
const collections = [
  {
    id: "brazil",
    name: "Brazil",
    description:
      "Selecionamos as madeiras nacionais de maior prestígio no exterior e produzimos os assoalhos de acordo com as melhores práticas do mercado internacional. Cumaru, Ipê, Tauari, Muiracatiara e Freijó em tábuas largas e acabamentos impecáveis.",
    images: [
      ...Array.from(
        { length: 6 },
        (_, i) =>
          `https://parket.com.br/wp-content/uploads/2025/10/PRO_PI_BR-${String(i + 1).padStart(2, "0")}.jpg`
      ),
      brazil_ext1,
    ],
  },
  ...
  },
  {
    ...
    name: "Clássicos",
    description:
      "Esta coleção é constituída por diversos tipos de madeiras, instalados das maneiras mais utilizadas durante décadas no mercado brasileiro e europeu. Espinha de peixe, chevron e paginação tradicional em madeiras nobres selecionadas.",
    images: [
      ...Array.from(
        { length: 10 },
        (_, i) =>
          `https://parket.com.br/wp-content/uploads/2025/10/PRO_PI_CL-${String(i + 1).padStart(2, "0")}.jpg`
      ),
      classico1,
      classico2,
      classico3,
  ...
  },
  {
    ...
    name: "Eternos",
    description:
      "Os pisos da coleção ETERNOS são constituídos por madeira de demolição de Canela, Peroba Rosa e outras espécies históricas. Cada tábua carrega décadas de história, reaproveitada com técnica e cuidado para novos projetos com alma e autenticidade.",
    images: [
      ...Array.from(
        { length: 9 },
        (_, i) =>
          `https://parket.com.br/wp-content/uploads/2025/10/PRO_PI_ET-${String(i + 1).padStart(2, "0")}.jpg`
      ),
      eterno1,
      eterno2,
      eterno3,
  ...
  },
  {
    ...
    name: "Grandiosos",
    description:
      "Esta coleção enaltece as grandes dimensões dos produtos mais desejados ao redor do mundo. Tábuas extralargas em espécies nobres que criam ambientes de presença marcante e amplitude visual incomparável.",
    images: Array.from(
      { length: 13 },
      (_, i) =>
        `https://parket.com.br/wp-content/uploads/2025/10/PRO_PI_GR-${String(i + 1).padStart(2, "0")}.jpg`
    ),
  },
  {
    id: "pinho-de-riga",
    name: "Pinho de Riga",
    description:
      "Os Pinhos de Riga, provenientes da floresta negra da Alemanha, podem crescer até 60 metros de altura. Madeira de fibra longa, densidade excepcional e tonalidade que amadurece com o tempo, conferindo caráter único ao piso.",
    images: Array.from(
      { length: 7 },
      (_, i) =>
        `https://parket.com.br/wp-content/uploads/2025/10/PRO_PI_PR-${String(i + 1).padStart(2, "0")}.jpg`
    ),
  },
  {
    id: "unicos",
    name: "Únicos",
    description:
      "Considerando que cada pessoa é única, desenvolvemos essa coleção para clientes autênticos, que buscam uma identidade exclusiva no seu piso. Projetos personalizados com espécies raras e acabamentos sob medida.",
    images: Array.from(
      { length: 4 },
      (_, i) =>
        `https://parket.com.br/wp-content/uploads/2025/10/PRO_PI_UN-${String(i + 2).padStart(2, "0")}.jpg`
    ),
  },
  {
    id: "wood-marmore",
    name: "Wood + Mármore",
    description:
      "A combinação de madeira com mármore nos proporciona um design exclusivo e maravilhoso! A fusão entre a nobreza da madeira e a sofisticação do mármore cria pisos de impacto visual extraordinário.",
    images: Array.from(
      { length: 11 },
      (_, i) =>
        `https://parket.com.br/wp-content/uploads/2025/10/PRO_PI_MA-${String(i + 1).padStart(2, "0")}.jpg`
    ),
  },
];
...
export function Pisos() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Pisos de Madeira — Maciço, Engenheirado, Carvalho Europeu e mais"
        description="8 coleções de pisos de madeira com mais de 80 imagens de projetos reais. Carvalho Europeu, Cumaru, Ipê, espinha de peixe e chevron. Solicite orçamento."
        url="https://parket.com.br/pisos"
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Pisos de madeira maciça e engenheirada para projetos residenciais e comerciais de alto
              padrão. {collections.length} coleções, mais de 80 imagens de projetos reais.
            </p>
          </motion.div>
        </div>
      </section>
