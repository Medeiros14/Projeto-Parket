...
// ─── Colunas do fluxo por ITEM (compras_itens_ativo=true) ───
// Aparecem no Kanban só quando há cards nelas (renderizadas dinamicamente).
// Slugs batem com public.compras_status_column_map + kanban_columns em Cloud.
export const COLUNAS_COMPRAS_ITENS: ColunaKanban[] = [
  { id: "ci-cotacao",              label: "Cotação",              cor: "#94A3B8" },
  { id: "ci-aguardando-financeiro", label: "Aguardando Financeiro", cor: "#EAB308", slaHours: 24 },
  { id: "ci-aprovado",             label: "Aprovado",             cor: "#8B5CF6" },
  { id: "ci-em-rota",              label: "Em Rota",              cor: "#3B82F6", slaHours: 48 },
  { id: "ci-entregue",             label: "Entregue",             cor: "#14B8A6" },
  { id: "ci-faturado",             label: "Faturado",             cor: "#F97316" },
  { id: "ci-pago",                 label: "Pago",                 cor: "#10B981" },
  { id: "ci-reprovado",            label: "Reprovado",            cor: "#EF4444" },
];
