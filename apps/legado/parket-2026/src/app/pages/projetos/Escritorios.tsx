...
const images = [
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ES-01.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ES-02.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ES-03.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ES-04.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ES-05.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ES-06.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ES-07.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ES-08.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ES-09.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ES-10.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/INS_ES-11.jpg",
];
...
export function Escritorios() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Escritórios — Projetos Parket"
        description="Inspire-se em projetos de escritórios corporativos com pisos e revestimentos em madeira nobre da Parket."
        keywords="escritórios, projetos corporativos, pisos de madeira, revestimentos, inspiração"
      />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Ambientes corporativos que elevam a produtividade através da madeira nobre. Projetos que combinam profissionalismo e elegância atemporal.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
            <div className="max-w-[800px]">
              <h2
                ...
                style={thin}
              >
                Projetos em Escritórios
              </h2>
              <p
                className="text-[#E8E4DF]/50 text-[15px] md:text-[16px] leading-[1.7]"
                style={regular}
              >
                Escritórios que aliam funcionalidade e sofisticação, utilizando madeira nobre para criar ambientes de trabalho inspiradores e acolhedores.
              </p>
            </div>
            ...
            >
              {images.map((img, i) => (
                ...
                >
                  <img
                    src={img}
                    alt={`Escritórios ${String(i + 1).padStart(2, "0")}`}
