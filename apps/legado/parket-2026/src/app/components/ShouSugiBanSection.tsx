...
export function ShouSugiBanSection() {
  ...
  const handleClick = () => {
    navigate(`/shou-sugi-ban#col-completo`);
  };

  return (
    <section id="shou-sugi-ban-section" className="bg-[#FAF8F5] py-14 md:py-24 overflow-hidden">
