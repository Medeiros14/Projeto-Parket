...
const images = [
  "https://parket.com.br/wp-content/uploads/2025/10/PRO_SA-01.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/PRO_SA-02.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/PRO_SA-03.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/PRO_SA-04.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/PRO_SA-05.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/PRO_SA-06.jpg",
  "https://parket.com.br/wp-content/uploads/2025/10/PRO_SA-08.jpg",
];
...
export function Spa() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Spa e Bem-Estar — Parket"
        description="Decks e revestimentos para áreas molhadas que unem o toque natural da madeira ao relaxamento absoluto."
      />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              O toque natural da madeira em sintonia com a água. Decks e revestimentos para áreas molhadas que convidam ao relaxamento absoluto.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-10 lg:px-20 text-center">
          ...
          >
            ...
            >
              ...
              diretamente com um especialista em spa.
            </p>
            <a
