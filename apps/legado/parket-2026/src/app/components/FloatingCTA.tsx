    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          className="fixed bottom-6 right-6 z-50 w-14 h-14 md:w-16 md:h-16 bg-[#25D366] flex items-center justify-center hover:bg-[#1EBE5D] transition-colors duration-300"
