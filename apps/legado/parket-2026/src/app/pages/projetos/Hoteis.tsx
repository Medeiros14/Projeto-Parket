...
export function Hoteis() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Hotéis — Projetos Parket"
        description="Inspire-se em projetos de hotéis com pisos e revestimentos em madeira nobre da Parket."
        keywords="hotéis, projetos, pisos de madeira, revestimentos, inspiração"
      />
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-12 md:pb-20 px-6 md:px-10 lg:px-20 max-w-[1280px] mx-auto left-0 right-0">
          ...
          >
            ...
            <p
              ...
              style={regular}
            >
              Espaços que combinam conforto e elegância através da madeira nobre. Projetos que transformam a experiência de hospedagem em uma vivência memorável.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
            <div className="max-w-[800px]">
              ...
              <p
                ...
                style={regular}
              >
                Hotéis que utilizam madeira nobre para criar experiências sensoriais únicas, onde cada espaço convida ao relaxamento e à contemplação.
              </p>
            </div>
            ...
            >
              {images.map((img, i) => (
                ...
                >
                  <img
                    src={img}
                    alt={`Hotéis ${String(i + 1).padStart(2, "0")}`}
